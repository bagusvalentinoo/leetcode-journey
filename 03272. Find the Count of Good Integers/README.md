<h1>
  <a href="https://leetcode.com/problems/find-the-count-of-good-integers/">
    3272. Find the Count of Good Integers
  </a>
</h1>
<img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' />
<img src='https://img.shields.io/badge/Topics-Hash%20Table%2C%20Math%2C%20Combinatorics%2C%20Enumeration-blue' alt='Topics: Hash Table, Math, Combinatorics, Enumeration' />
...
<ul>
	<li><code>x</code> is a <span data-keyword="palindrome-integer" class=" cursor-pointer relative text-dark-blue-s text-sm"><button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:rp:" data-state="closed" class="">palindrome</button></span>.</li>
