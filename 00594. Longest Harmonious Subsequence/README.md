...
<img src='https://img.shields.io/badge/Topics-Array%2C%20Hash%20Table%2C%20Sliding%20Window%2C%20Sorting%2C%20Counting-blue' alt='Topics: Array, Hash Table, Sliding Window, Sorting, Counting' />
...
<p>Given an integer array <code>nums</code>, return the length of its longest harmonious <span data-keyword="subsequence-array" class=" cursor-pointer relative text-dark-blue-s text-sm"><button type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r7u:" data-state="closed" class="">subsequence</button></span> among all its possible subsequences.</p>
