 ...
 *
 * @param {number[]} releaseTimes - Release time of each keypress
 * @param {string} keysPressed - Keys pressed in testing sequence
 *
 * @returns {string} Key with the longest duration
 */
