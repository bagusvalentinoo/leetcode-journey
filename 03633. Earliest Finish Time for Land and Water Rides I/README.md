<h1>
  <a href="https://leetcode.com/problems/earliest-finish-time-for-land-and-water-rides-i/">
    3633. Earliest Finish Time for Land and Water Rides I
  </a>
</h1>

<img src="https://img.shields.io/badge/Difficulty-Easy-greenlight" alt="Difficulty: Easy" />
<img src="https://img.shields.io/badge/Topics-Mid%20Level%2C%20Array%2C%20Two%20Pointers%2C%20Binary%20Search%2C%20Greedy%2C%20Sorting%2C%20Biweekly%20Contest%20162-blue" alt="Topics: Mid Level, Array, Two Pointers, Binary Search, Greedy, Sorting, Biweekly Contest 162" />
...
<ul>
    <li data-end="163" data-start="147">
        <strong data-end="161" data-start="147">Land rides</strong>
        <ul>
            <li data-end="245" data-start="168">
                <code data-end="186" data-start="168">landStartTime[i]</code> – the earliest time the <code>i<sup>th</sup></code> land ride can be boarded.
            </li>
            <li data-end="306" data-start="250">
                <code data-end="267" data-start="250">landDuration[i]</code> – how long the <code>i<sup>th</sup></code> land ride lasts.
            </li>
        </ul>
    </li>
    <li data-end="325" data-start="310">
        <strong data-end="325" data-start="310">Water rides</strong>
        <ul>
            <li data-end="378" data-start="332">
                <code data-end="351" data-start="332">waterStartTime[j]</code> – the earliest time the <code>j<sup>th</sup></code> water ride can be boarded.
            </li>
            <li data-end="434" data-start="416">
                <code data-end="434" data-start="416">waterDuration[j]</code> – how long the <code>j<sup>th</sup></code> water ride lasts.
            </li>
        </ul>
    </li>
</ul>
