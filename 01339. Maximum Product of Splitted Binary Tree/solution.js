 ...
 *
 * @returns {number} - Maximum product modulo 10^9+7
 */
 ...
 * @param {object} result - Object to store maximum product
 * @param {number} treeSum - Total sum of all nodes in the tree
 *
 * @returns {number} - Sum of current subtree
 */
const getSum = (root, result = null, treeSum = 0) => {
