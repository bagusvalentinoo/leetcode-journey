 ...
 *
 * @param {number[]} arr - Target array of distinct integers
 * @param {number[][]} pieces - Array of pieces that cannot be reordered internally
 *
 * @returns {boolean} True if arr can be formed from pieces
 */
