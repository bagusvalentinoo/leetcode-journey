<h1>
  <a href="https://leetcode.com/problems/stone-game-viii/">
    1872. Stone Game VIII
  </a>
</h1>

<img src="https://img.shields.io/badge/Difficulty-Hard-darkred" alt="Difficulty: Hard" />
<img src="https://img.shields.io/badge/Topics-Senior%20Staff%2C%20Array%2C%20Math%2C%20Dynamic%20Programming%2C%20Minimax%2C%20Prefix%20Sum%2C%20Game%20Theory%2C%20Zero-Sum%20Game%2C%20Weekly%20Contest%20242-blue" alt="Topics: Senior Staff, Array, Math, Dynamic Programming, Minimax, Prefix Sum, Game Theory, Zero-Sum Game, Weekly Contest 242" />
...
<ol>
	<li>Choose an integer <code>x &gt; 1</code>.</li>
	<li>Remove the leftmost <code>x</code> stones from the row.</li>
	<li>Add the <strong>sum</strong> of the removed stones' values to the player's score.</li>
...
<strong>Explanation:</strong>
- Alice removes all 7 stones, adds 7 + (-6) + 5 + 10 + 5 + (-2) + (-6) = 13 to her score, and places a
...
<strong>Explanation:</strong>
- Alice can only remove the first 2 stones, adds (-10) + (-12) = -22 to her score, and places a
  stone of value -22 on the left. stones = [-22].
