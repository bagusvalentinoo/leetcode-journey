...
<img src="https://img.shields.io/badge/Topics-Two%20Pointers%2C%20String%2C%20Weekly%20Contest%20173-blue" alt="Topics: Two Pointers, String, Weekly Contest 173" />
...
<p>A string is a <strong>subsequence</strong> of a given string if it is generated by deleting zero or more characters from the given string without changing its order.</p>

<p>A string is called a <strong>palindrome</strong> if it is one that reads the same backward as well as forward.</p>
